<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">AppStack</span></a>
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
						...
						<ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
							<li class="sidebar-item"><a class="sidebar-link" href="<?php echo base_url('pages/test')?>">Default</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="<?php echo base_url('pages/dashboard')?>">Analytics</a></li>
